let lista = ["mele","pere","banane","uova","kiwi"];
...
function lista_destroy() {
    ...
    if (conferma == "y") {
        ...
        alert("La lista è stata eliminata correttamente.")
        return

    } else if (conferma == "n") {

        alert("Operazione annullata, ritorno al menù principale.")
        return


    } else {

        alert("Comando non riconosciuto, ritorno al menù principale.")
        return
